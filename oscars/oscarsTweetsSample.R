...
oscarsTweets<-searchTwitter("#oscars",lang = "en", n=1000) 

#### 5. transform from List to DataFrame =====
oscarsTweets.df=twListToDF(oscarsTweets)

#### 6. view DataFrame =====
View(oscarsTweets.df)

#### 7. down load as csv file  =====
write.csv(oscarsTweets.df, file="C:\\Saipriya\\Studies\\Fall 2017\\WebAnalytics\\Exercise 3\\oscarsTweets.df.csv", row.names=F)

#### 8. save R.Data  =====
save.image("C:\\Saipriya\\Studies\\Fall 2017\\WebAnalytics\\Exercise 3\\windowsTweetsOscars.RData") 
#### End
